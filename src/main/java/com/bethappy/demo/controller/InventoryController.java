...
public class InventoryController {
    ...
    public ResponseEntity<Object> addCharacterItem(@RequestBody String bodyJson) throws JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        TypeReference<HashMap<String,String>> typeRef = new TypeReference<HashMap<String,String>>() {};
        Map<String, String> map = objectMapper.readValue(bodyJson, typeRef);
        //get character based on id number
        Optional<Characters> currentChar = charactersRepository.findById(Long.parseLong(map.get("id")));
        ...
        Inventory newItem = new Inventory(currentChar.get(),Integer.valueOf(map.get("slot_number")),Integer.valueOf(map.get("amount")));
        Inventory item = inventoryRepository.save(newItem);
